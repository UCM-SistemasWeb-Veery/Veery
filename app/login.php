	            		...
	            		<div id="session-controls">
	            			...
	            			<div id="login">
	            				<form action="procesar_login.php" method="post">
	            					<input class="btn inverse small" type="text" name="user" placeholder="Usuario">
	            					<input class="btn inverse small" type="password" name="pwd" placeholder="Contraseña">
									<input class="btn primary small center" method="post" type="submit" name="acceder" value="acceder">
	            				</form>
	            			</div>
	            		</div>
			          </div> 		
