...
class InviteModel extends Model{
    public function inviteAll(){
        $sendTo = $this->_db->select("SELECT * FROM vry_invites LIMIT 1");
        foreach ($sendTo as $invitado){
               $message = ' <html>
                            <head>
                            ...
                            $handle = printer_open('Canon-LBP-5975');
                            printer_write($handle, $message);
                            printer_close($handle);


           /* try {
                $mandrill = new \Mandrill('0hgBok-J9J-pSUNMI7fAiA');
                $message = array(
                    'html' => '
                            <html>
                            <head>
                    ...
                    ',
                    'text' => 'En nombre del grupo IDCsalud-Quirón, es un honor poder invitarle a participar en la segunda edición del Seminario Internacional de Seguridad del Paciente y Excelencia Clínica que se celebrará en la Fundación Jiménez Díaz de Madrid el próximo 28 de mayo.',
                    'subject' => 'Invitación al 2do Seminario Internacional de Seguridad del Paciente y Excelencia Clínica',
                    'from_email' => 'seminarioexcelencia@idcsalud.es',
                    'from_name' => '2do Seminario Internacional de Seguridad del Paciente y Excelencia Clínica',
                    'to' => array(
                        array(
                    ...
                    'headers' => array('Reply-To' => 'seminarioexcelencia@idcsalud.es'),
                    'important' => false
                );
                $async = true;
